...
for seq in range(10):
    while(True):
        ...
        send_packet.send_message(sock, (server_ip, server_port), seq, message)
        ...
        print(f'Received response from server: message:{message}, sequence_number:{sequence_number}, is_valid:{is_valid}')
